                            ...
                            <div className="space-y-6">
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            <h2 className="text-2xl font-bold text-textPrimary">{editedPlayer?.name}</h2>
                                    ...
                                    <div className="md:col-span-1 space-y-4">
                                        {isEditing ? (
                                            <div className="space-y-4">
                                                ...
                                                <div><label className="block text-sm font-medium text-textPrimary mb-1">{translate('playerInfo.bio')}</label><textarea value={editedPlayer?.bio || ''} onChange={e => setEditedPlayer(p => p ? {...p, bio: e.target.value} : null)} placeholder={translate('playerInfo.bioPlaceholder')} rows={3} className={inputClasses}></textarea></div>
                                            </div>
                                        ) : (
                                            <div className="space-y-2 text-sm text-textSecondary">
                                                 <p><strong className="text-textPrimary">{translate('playerInfo.bio')}:</strong> {selectedPlayer.bio || 'N/A'}</p>
                                            </div>
                                        )}
                                         <h3 className="text-lg font-semibold text-textPrimary pt-4 border-t border-border">{translate('playerDetailModal.skillsTitle')}</h3>
