...
export const AdminDashboardPage: React.FC = () => {
  ...
  return (
    <div className="space-y-8">
      ...
      {!isBettingEnabled ? (
        <div className="p-3 bg-red-100 dark:bg-red-500/20 border border-red-300 dark:border-red-500/40 text-sm text-red-700 dark:text-red-200 rounded-2xl flex items-center">
            <ShieldExclamationIcon className="w-5 h-5 mr-2"/>
            Betting is globally disabled. Enable it above to create or manage betting rounds.
        </div>
      ) : !apiAvailable && (
         <div className="p-3 bg-yellow-100 dark:bg-yellow-500/20 border border-yellow-300 dark:border-yellow-500/40 text-sm text-yellow-700 dark:text-yellow-200 rounded-2xl flex items-center">
            <ShieldExclamationIcon className="w-5 h-5 mr-2"/>
